      ...
      <div className="w-full flex flex-col gap-4  p-5">
        ...
        <fieldset className="w-full gap-3 flex">
          ...
          <section className="w-[40%]  border rounded-lg p-3 flex flex-col gap-5  ">
            ...
            <div className="w-full gap-3 justify-between  flex items-center">
              <label htmlFor="repayment_period">
          ...
          <motion.section ref={loanOverviewRef} drag dragConstraints={{left:-600,top:-300,right:20,bottom:10}}  className="w-[60%]  dark:bg-darkmode-2 bg-white rounded-lg border">
            <div className="w-full flex justify-between p-2 border-b border-inherit">
              ...
              <span onClick={()=>handleExpand(loanOverviewRef,setExpand,expand)} className="border rounded-md flex items-center dark:border-slate-600 dark:border-b justify-center p-2 cursor-pointer"><FaExpand/></span>
            </div>
            <div>
