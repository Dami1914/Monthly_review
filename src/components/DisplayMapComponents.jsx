...
const DisplayMapComponents = ({ componentData }) => {
  ...
  return (
  <div className="w-full relative overflow-y-scroll rounded-xl scrollbar-hide bg-lightmode-1 dark:bg-darkmode-2 h-full">
      <section className="w-full z-[2]  gap-4 px-5 border-y border-t-0 p-2 flex h-[8%] backdrop-filter backdrop-blur-xl top-0 m-0 sticky">
